...
<div class="page page--guest-order flex flex-col gap-5 max-w-3xl mx-auto w-full">
    ...
    <div class="flex flex-col gap-1 pt-2">
        ...
        <p class="text-sm text-body/70 m-0 flex items-center gap-1.5">
            <svg class="w-3.5 h-3.5 shrink-0 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <div class="bg-surface-card border border-border-subtle rounded-lg p-5 flex flex-col gap-4">
        <div class="flex items-start justify-between gap-3 flex-wrap">
            <div class="flex flex-col gap-2">
                ...
                <span @class([ 'inline-flex items-center self-start rounded-md px-2 py-0.5 text-xs font-medium' , 'bg-surface-success-subtle text-surface-success-subtle-content'=> orderStatusTone($order->status ?? null) === 'success',
        ...
        <dl class="grid grid-cols-2 sm:grid-cols-4 gap-4 m-0 pt-1 border-t border-border-subtle">
            <div class="flex flex-col gap-0.5 pt-3">
                ...
                <dd class="text-sm text-headings m-0">{{ formatDate($order->_created_at ?? null, 'DD/MM/YYYY') }}</dd>
            </div>
            <div class="flex flex-col gap-0.5 pt-3">
