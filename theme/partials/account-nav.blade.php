...
<nav class="account__nav md:w-64 flex-shrink-0" aria-label="@t('Account')">
    <div class="flex flex-col p-2 bg-surface-card border border-border-subtle rounded-lg">
        <a href="@routeUrl('store.account.index')" @class([ 'account__nav-link flex items-center gap-3 px-3 py-2.5 rounded-md text-sm no-underline transition-colors' , 'bg-primary-subtle text-primary font-semibold'=>
            ($active ?? '') === 'dashboard',
        ...
        <a href="@routeUrl('store.account.profile')" @class([ 'account__nav-link flex items-center gap-3 px-3 py-2.5 rounded-md text-sm no-underline transition-colors' , 'bg-primary-subtle text-primary font-semibold'=> ($active ?? '') === 'profile',
            'text-headings font-medium hover:bg-surface-hover' =>
            ($active ?? '') !== 'profile',
            ])
        ...
        <a href="@routeUrl('store.account.orders')" @class([ 'account__nav-link flex items-center gap-3 px-3 py-2.5 rounded-md text-sm no-underline transition-colors' , 'bg-primary-subtle text-primary font-semibold'=> ($active ?? '') === 'orders',
            'text-headings font-medium hover:bg-surface-hover' =>
            ($active ?? '') !== 'orders',
            ])
        ...
        <a href="@routeUrl('store.account.quick-order.index')"
            @class([ 'account__nav-link flex items-center gap-3 px-3 py-2.5 rounded-md text-sm no-underline transition-colors' , 'bg-primary-subtle text-primary font-semibold'=> ($active ?? '') === 'quick-order',
        ...
        <a href="@routeUrl('store.account.shipping-addresses')" @class([ 'account__nav-link flex items-center gap-3 px-3 py-2.5 rounded-md text-sm no-underline transition-colors' , 'bg-primary-subtle text-primary font-semibold'=>
            ($active ?? '') === 'addresses',
            'text-headings font-medium hover:bg-surface-hover' =>
            ($active ?? '') !== 'addresses',
            ])
        ...
        <a href="@routeUrl('store.account.api-keys')" @class([ 'account__nav-link flex items-center gap-3 px-3 py-2.5 rounded-md text-sm no-underline transition-colors' , 'bg-primary-subtle text-primary font-semibold'=>
            ($active ?? '') === 'api-keys',
            'text-headings font-medium hover:bg-surface-hover' =>
            ($active ?? '') !== 'api-keys',
            ])
        ...
        <a href="@routeUrl('store.favorites')" @class([ 'account__nav-link flex items-center gap-3 px-3 py-2.5 rounded-md text-sm no-underline transition-colors' , 'bg-primary-subtle text-primary font-semibold'=>
            ($active ?? '') === 'favorites',
            'text-headings font-medium hover:bg-surface-hover' =>
            ($active ?? '') !== 'favorites',
            ])
        ...
        <a href="@routeUrl('store.account.catalog-export')" @class([ 'account__nav-link flex items-center gap-3 px-3 py-2.5 rounded-md text-sm no-underline transition-colors' , 'bg-primary-subtle text-primary font-semibold'=>
