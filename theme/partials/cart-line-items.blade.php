    ...
    <li
        ...
        <div class="cart__item-product flex gap-4 items-start flex-1 min-w-0">
            ...
            <div class="cart__item-info flex-1 min-w-0 flex flex-col gap-1">
                <a
                    href="@routeUrl('store.product', ['identifier' => $line['slug'] !== '' ? $line['slug'] : $line['product_id']])"
                    class="cart__item-name text-headings text-sm font-medium hover:text-primary hover:no-underline">{{ $line['name'] }}</a>
        ...
        <div class="cart__item-controls flex flex-wrap items-center justify-between gap-4 desktop:gap-6 desktop:justify-end">
            ...
            <div class="cart__item-price flex flex-col items-end gap-1 min-w-24">
                ...
                <div class="cart__item-rules flex flex-col items-end gap-1 mt-0.5">
                    ...
                    <span class="inline-flex items-center gap-1 rounded bg-surface-card px-2 py-0.5 text-xs font-medium text-success border border-success/30 shadow-xs">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 shrink-0 text-success" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
